...
export default class FirstTimerPage extends React.Component {    
    ...
    render() {
        ...
        this.props.navigation.navigate('Adjust Timer', {focus: this.FOCUS_PERIOD, longbreak: this.LONGBREAK_PERIOD, shortbreak: this.REST_PERIOD, session: this.SESSION})
                    } >
                  <MaterialCommunityIcons
                    name="tune-vertical"
                    size={35}
