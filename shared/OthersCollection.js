...
export default OthersScreen = () => {
  ...
  const getAllData = async () =>{
      const snapshot = await firebase.firestore().collection('toDoOthers').onSnapshot(snapshot=>{
...
const updateItem = async (id) => {
  ...
  >
    ...
    padding:5, 
    borderRadius:8}}  onPress={() => navigation.navigate('Others')}>
          <Text style={{paddingHorizontal:5, 
    fontSize:19,
    color:theme.background}}>Others</Text>
        </TouchableOpacity>
      </View>
      </ScrollView>
    </View>
